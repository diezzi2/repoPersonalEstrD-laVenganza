...
-- Reimplementar como usuario de MultiSet la función ocurrencias de ejercicios anteriores, que dado un string cuenta la cantidad de ocurrencias de cada caracter en el string.
-- En este caso el resultado será un multiconjunto de caracteres.
