...
-- Un MultiSet (multiconjunto) es un tipo abstracto de datos similar a un Set (conjunto).
-- A diferencia del último, cada elemento posee una cantidad de apariciones, que llamaremos ocurrencias del elemento en el multiset.

-- Implementar el tipo abstracto MultiSet utilizando como representación un Map.
-- Indicar los ordenes de complejidad en peor caso de cada función de la interfaz, justificando las respuestas.
